...
from utils import create_network_with_nn,ReplayBuffer,create_network_end_activation
...
def main():
    ...
    for i in range(epochs):
        ...
        if i%50==0:
            torch.save(agent.PNetwork_.PNetwork_current.state_dict(), "models/%04d.ckpt"%i)
